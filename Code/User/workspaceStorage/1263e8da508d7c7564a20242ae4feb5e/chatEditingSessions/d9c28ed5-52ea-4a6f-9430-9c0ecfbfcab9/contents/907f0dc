<template>
  <section class="min-h-screen bg-gradient-to-br from-genius-gray-900 via-genius-purple-900 to-genius-blue-600 relative overflow-hidden py-24">
                ...
                <div class="form-group text-right">
                  ...
                  <div class="relative">
                    <input
                      ...
                      :class="{ 'border-red-500 focus:border-red-500 focus:ring-red-500/40': form.errors.email }"
                      required>
                    <!-- Updated email icon -->
                  ...
                  <span v-if="form.errors.email" class="text-red-400 text-sm mt-2 block">{{ form.errors.email }}</span>
                </div>
                <!-- Password field -->
                <div class="form-group text-right">
                  ...
                  <div class="relative">
                    <input
                      ...
                      :class="{ 'border-red-500 focus:border-red-500 focus:ring-red-500/40': form.errors.password }"
                      required>
                    <!-- Updated eye icons -->
                    <button
                      type="button"
                  ...
                  <span v-if="form.errors.password" class="text-red-400 text-sm mt-2 block">{{ form.errors.password }}</span>
                </div>
...
const submitForm = () => {
  form.post(route('login'), {
    ...
    onError: () => {
      ...
      // They will be automatically available in form.errors
    }
  });
};
