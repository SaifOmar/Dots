        ...
        <div class="mb-12">
          <div class="flex flex-col md:flex-row md:space-x-4">
            ...
            <div class="flex-1 mb-4 md:mb-0">
              <input type="text" placeholder="ابحث عن مادة أو صف..." 
                     v-model="searchQuery" 
                     class="w-full px-4 py-3 bg-genius-gray-800 border border-genius-gray-700 rounded-xl focus:ring-2 focus:ring-genius-blue-500 focus:outline-none transition-all duration-300"
