		  ...
		  <div class="hidden lg:flex items-center space-x-8 space-x-reverse text-white">
			...
			<div class="group relative">
			  ...
			  <div class="absolute top-full right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
				<Link href="/courses" class="block px-4 py-2 hover:bg-gray-700 rounded-t-lg">جميع الدورات</Link>
				<Link href="/courses/grade-4" class="block px-4 py-2 hover:bg-gray-700">الصف الرابع</Link>
				<Link href="/courses/grade-5" class="block px-4 py-2 hover:bg-gray-700">الصف الخامس</Link>
				<Link href="/courses/grade-6" class="block px-4 py-2 hover:bg-gray-700">الصف السادس</Link>
				<Link href="/courses/preparatory" class="block px-4 py-2 hover:bg-gray-700 rounded-b-lg">المرحلة الإعدادية</Link>
			  </div>
			</div>
