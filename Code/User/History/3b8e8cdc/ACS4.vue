			...
			<div class="group relative">
			  <button class="flex items-center hover:text-blue-400 transition-colors">
				...
				<div class="absolute top-full right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
				 ...
				 <Link :href="route('courses.by_level', {'level': levels[0].slug})" class="block px-4 py-2 hover:bg-gray-700">الصف الرابع</Link>
				 <!-- <Link :href="route('courses.by_level')" class="block px-4 py-2 hover:bg-gray-700">الصف الخامس</Link> -->
				 <!-- <Link :href="route('courses.by_level')" class="block px-4 py-2 hover:bg-gray-700">الصف السادس</Link> -->
				 <!-- <Link :href="route('courses.by_level')" class="block px-4 py-2 hover:bg-gray-700 rounded-b-lg">المرحلة الإعدادية</Link> -->
				</div>
			</div>
