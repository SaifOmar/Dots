...
const timer = ref(null) // Add timer ref to store interval
...
const finishQuiz = () => {
  ...
  cleanupTimer() // Ensure timer is cleaned up

  router.post(route('quiz.answers.store', props.quiz.id), {
...
onMounted(() => {
  ...
  // Add pause/resume functionality for when tab is hidden
